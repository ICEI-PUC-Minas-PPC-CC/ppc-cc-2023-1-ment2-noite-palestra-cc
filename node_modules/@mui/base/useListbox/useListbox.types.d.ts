...
type UseListboxStrictParametersRequiredKeys = 'isOptionDisabled' | 'disableListWrap' | 'disabledItemsFocusable' | 'optionComparer' | 'optionStringifier' | 'selectionLimit';
export type UseListboxParametersWithDefaults<TOption> = Omit<UseListboxParameters<TOption>, UseListboxStrictParametersRequiredKeys> & Required<Pick<UseListboxParameters<TOption>, UseListboxStrictParametersRequiredKeys>>;
